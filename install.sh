...
tls_config() {
	...
	while :; do
		...
		read -p "(例如：zhujiduibi.com): " domain
...
while :; do
	...
	echo
	echo "查看搭建V2ray节点教程: https://www.zhujiduibi.com"
	echo
	echo "懒得搭建,购买收费节点: https://www.zhujiduibi.com/74.html"
	echo
	echo " 1. 安装"
	echo
	echo " 2. 卸载"
	...
	read -p "$(echo -e "请输入数字： 1 或者 2 为确定安装还是卸载本脚本 [${magenta}1-2$none]:")" choose
	case $choose in
	1)
		install
		break
